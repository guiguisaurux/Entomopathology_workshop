...
aov_4.5
interaction.plot(teneb$Treatment,teneb$Colonies,teneb$Daysto4.5,type=b)
...
boxplot(tenebag$Daysto4.5~tenebag$Colonies,
        ylab = "Temps requis pour l'atteinte de 4.5 g (j)", 
        xlab = bquote("Souches de " * italic("T. molitor")),
        col =c("lightcoral","lightblue","lightgreen"))
...
boxplot(tenebcar$Daysto4.5 ~ tenebcar$Colonies, 
        ylab = "Temps requis pour l'atteinte de 4.5 g (j)", 
        xlab = bquote("Souches de " * italic("T. molitor")),
        col =c("lightcoral","lightblue","lightgreen"))
